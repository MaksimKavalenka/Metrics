...
public enum Transport {
    ...
    REST("REST",
            new ParametersElement("http://localhost:8080/metrics/rest/metric", null, null, null)) {
        @Override
    ...
    SOAP("SOAP", new ParametersElement("http://localhost:8080/metrics/soap", null, null, null)) {
        @Override
        public TransportDAO createDAO(final ParametersElement parameters) {
    ...
    RMI("RMI", new ParametersElement(null, "localhost", "8082", "metrics/rmi")) {
        @Override
        public TransportDAO createDAO(final ParametersElement parameters) {
